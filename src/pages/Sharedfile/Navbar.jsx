...
const Nav = () => {
  ...
  return (
    <div className=' w-full fixed top-0 left-0'>
      ...
      <div className='font-bold text-2xl cursor-pointer font-bold flex items-center font-[Poppins] 
      text-white mb-2'>
      ...
      <ul className={`md:flex  md:items-center md:pb-0 pb-12 absolute md:static bg-black bg-opacity-25 md:z-auto z-[10] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20 ':'top-[-490px]'}`}>
        {
          Links.map((link)=>(
